...
export default function ProjectListItem({ project }: ProjectListItemProps) {
  ...
  return (
    <div className="group bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 cursor-pointer">
